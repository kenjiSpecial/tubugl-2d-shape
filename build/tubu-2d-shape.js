(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('gl-matrix/src/gl-matrix'), require('tubugl-core'), require('tubugl-utils'), require('tubugl-math/src/vector3'), require('tubugl-math/src/euler'), require('tubugl-core/src/arrayBuffer'), require('tubugl-core/src/program')) :
	typeof define === 'function' && define.amd ? define(['exports', 'gl-matrix/src/gl-matrix', 'tubugl-core', 'tubugl-utils', 'tubugl-math/src/vector3', 'tubugl-math/src/euler', 'tubugl-core/src/arrayBuffer', 'tubugl-core/src/program'], factory) :
	(factory((global.Tubu = {}),global.glMatrix,global.tubuglCore,global.tubuglUtils,global.vector3,global.euler,global.arrayBuffer,global.program));
}(this, (function (exports,glMatrix,tubuglCore,tubuglUtils,vector3,euler,arrayBuffer,program) { 'use strict';
